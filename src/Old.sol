 ...
 * @title DSCEngine
 * @author Tuan Anh
 * The system is designed to be as minimal as possible, and have the token maintained 
 * a 1 token == 1 USD peg.
 ...
 * and wBTC.
 * 
 * Our DSC system should always be "overcollaterflized". At no point, should the value of
 * all collateral <= the $ backed value of all the DSC.
 * 
 * @notice This contract is the core of the DSC system. It handles all the logic for minting, and redeeming DSC, 
 * as well as depositing and widthdrawing collateral.
